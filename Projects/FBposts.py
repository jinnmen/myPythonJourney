...
def processFacebookPageFeedStatus(status_id, access_token):
	...
	status_published = status_published.strftime(
			'%Y-%m-%d %H:%S') # best time format for spreadsheet programs
	...
	#C ounts of each reaction separately; good for sentiment
	...
	# Special case: Set number of Likes to Number of reactions for pre-reactions
	# statuses
